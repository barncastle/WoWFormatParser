...
using System.IO;
using System.Linq;
using WoWFormatParser.Archives.MPQ.Native;
using WoWFormatParser.Helpers;

namespace WoWFormatParser.Archives.MPQ
{
    public class MpqArchive : IDisposable
    {
        ...
        public bool HasFile(string fileToFind)
        {
            ...
            return NativeMethods.SFileHasFile(_handle, fileToFind) && NativeMethods.SFileVerifyFile(_handle, fileToFind, 0) == (uint)MpqFileVerificationResults.Verified;
        }
